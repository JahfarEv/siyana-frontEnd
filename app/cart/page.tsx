...
// const totalItems = safeCart.reduce((total, item) => {
//   const qty = toNumber(item?.quantity);
//   return total + qty;
// }, 0);

// const subtotal = safeCart.reduce((total, item) => {
//   const price = toNumber(item?.price);      // handles "₹60000"
//   const qty = toNumber(item?.quantity);     // handles "3" or 3
//   return total + price * qty;
// }, 0);
// console.log(subtotal,'sub');


// const savings = safeCart.reduce((total, item) => {
//   const original = toNumber(item?.originalPrice);
//   const price = toNumber(item?.price);
//   const qty = toNumber(item?.quantity);

//   if (original > price) {
//     return total + (original - price) * qty;
//   }
//   return total;
// }, 0);
...
export default function CartPage(): ReactElement {  
  ...
  // Only product price total - no tax, shipping, or other charges
